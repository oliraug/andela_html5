...
<div class="panel-panel btn-white" style="max-width: 100rem;">
  <div class="card-header">Taken Picture for <?php echo $result['fname'] . '&nbsp' . $result['mname'] . '&nbsp;' . $result['lname'] .'&nbsp;' . $result['pid'];?>
    ...
    <button type="submit" name="submit" id="take_snapshots"class="btn btn-success btn-lg">Take Snapshots</button>
      ...
      <div class="text-center">
        <div id="camera_info"></div><br>
    <div id="camera"></div><br>
    <button type="submit" name="submit" id="update_snapshots"class="btn btn-success btn-lg">Update Photo</button>
...
<div class="col-lg-3">
            ...
            <thead><br>
                    ...
                    <div class="card-header">PATIENT PICTURE 
                      <hr>
            
            <img src="<?php echo($result['Image'])?>" style="width: 14em;height: 12em;border-radius: 5%;"><br><hr>
           <!-- <?php //echo $result['fname'] . '&nbsp;' . $result['lname'] . '&nbsp;' . $result['pid'];?>-->
            </div>
</div>
        </thead>
      </table>
...
$('#imagelist').prepend("<tr><td><img src='"+response+"' width='100px' height='100px'></td><td>"+response+"</td></tr>");
 ...
 // alert("Upload failed with status " + response);
  ...
  $('#update_snapshots').click(function(){
    var snapshot = camera.capture();
    snapshot.show();
